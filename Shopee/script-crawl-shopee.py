...
# Open URL
driver.get("https://shopee.vn/%C4%90i%E1%BB%87n-Tho%E1%BA%A1i-Ph%E1%BB%A5-Ki%E1%BB%87n-cat.11036030")
...
while True:
        ...
        try:
            ...
            titles = driver.find_elements(By.CSS_SELECTOR , "._7V9Hys .j5GxYe")
